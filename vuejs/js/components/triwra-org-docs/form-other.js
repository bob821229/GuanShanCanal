...
export default {
  ...
  validations() {
    return {
      formData: {
            ...
            docName:  { required: helpers.withMessage('必填', required) },
            attachmentList: { 
  ...
  <form>
      ...
      -->
      <div class="mb-3">
        <label for="exampleInputPassword1" class="form-label required">文件名稱</label>
        <input type="text" class="form-control" id="" name="" v-model="inputFormData.docName" :disabled="ifReadOnly">
        <p v-for="error of v$.formData.docName.$errors"
